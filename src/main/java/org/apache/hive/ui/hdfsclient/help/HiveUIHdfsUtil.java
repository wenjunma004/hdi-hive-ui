...
package org.apache.hive.ui.hdfsclient.help;
...
public class HiveUIHdfsUtil {
  private final static Logger LOG =
      LoggerFactory.getLogger(HiveUIHdfsUtil.class);
   ...
   */
  public static void putStringToFile(final HiveUIHdfsApi hdfs,final String filePath, final String content) throws HdfsApiException {
   ...
   * @param filePath path to file
   */
  public static String readFile(HiveUIHdfsApi hdfs, String filePath) throws HdfsApiException {
   ...
   */
  public static String findUnallocatedFileName(HiveUIHdfsApi hdfs, String fullPathAndFilename, String extension)
...
//   * @throws HdfsApiException
//   */
//  public static synchronized HdfsApi connectToHDFSApi()
//    throws HdfsApiException {
...
//  }
  ...
  /**
   * Factory of HdfsApi for s
   * @return HdfsApi object
   */
  public static synchronized HiveUIHdfsApi connectToHDFSApi() throws HdfsApiException {
    ClassLoader currentClassLoader = Thread.currentThread().getContextClassLoader();
    Thread.currentThread().setContextClassLoader(HiveUIHdfsUtil.class.getClassLoader());
    try {
      return getHdfsApi();
    } finally {
      Thread.currentThread().setContextClassLoader(currentClassLoader);
  ...
  private static HiveUIHdfsApi getHdfsApi() throws HdfsApiException {
    HiveUIHdfsApi api = null;
    try {
      api = new HiveUIHdfsApi(getHdfsUsername());
