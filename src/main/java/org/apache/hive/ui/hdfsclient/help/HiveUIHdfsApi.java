 ...
 */
public class HiveUIHdfsApi {
  private final static Logger LOG =
      LoggerFactory.getLogger(HiveUIHdfsApi.class);
   ...
   */
  public HiveUIHdfsApi(String username) throws IOException,
      InterruptedException, HdfsApiException {
    //conf = configurationBuilder.buildConfig();
    conf = ConfigurationBuilder.buildConfig();
    LOG.info("----final conf:"+ conf);
   ...
   */
  HiveUIHdfsApi(Configuration configuration, FileSystem fs, UserGroupInformation ugi) throws IOException,
      InterruptedException, HdfsApiException {
