...
import org.apache.hive.ui.actor.message.job.UpdateYarnAtsGuid;
...
public class StatementExecutor extends HiveActor {
  ...
  public StatementExecutor(HiveUIHdfsApi hiveUIHdfsApi,  HiveConnection connection, ConnectionDelegate connectionDelegate) {
  ...
  private void startLogAggregation(HiveStatement statement, String sqlStatement, String logFile) {
    if (logAggregator == null) {
      logAggregator = getContext().actorOf(
        Props.create(LogAggregator.class, hiveUIHdfsApi, logFile)
