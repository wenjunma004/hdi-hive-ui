...
import org.apache.hive.ui.resources.browser.DDLService;
 ...
 */
@ApplicationPath("/")
public class HiveUIApplication extends Application {
    ...
    public Set<Class<?>> getClasses() {
        ...
        classes.add(HelpService.class);
        classes.add(UDFService.class);
        classes.add(FileResourceService.class);
