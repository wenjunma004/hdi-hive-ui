...
package org.apache.hive.ui.resources.browser;
...
import org.apache.hive.ui.client.DDLDelegator;
import org.apache.hive.ui.client.DDLDelegatorImpl;
import org.apache.hive.ui.client.DatabaseMetadataWrapper;
import org.apache.hive.ui.client.HiveClientException;
import org.apache.hive.ui.client.Row;
import org.apache.hive.ui.exceptions.ServiceException;
import org.apache.hive.ui.internal.dto.ColumnStats;
import org.apache.hive.ui.internal.dto.DatabaseInfo;
import org.apache.hive.ui.internal.dto.DatabaseResponse;
import org.apache.hive.ui.internal.dto.TableInfo;
import org.apache.hive.ui.internal.dto.TableMeta;
import org.apache.hive.ui.internal.dto.TableResponse;
import org.apache.hive.ui.internal.parsers.TableMetaParserImpl;
import org.apache.hive.ui.internal.query.generators.AlterTableQueryGenerator;
import org.apache.hive.ui.internal.query.generators.AnalyzeTableQueryGenerator;
import org.apache.hive.ui.internal.query.generators.CreateDatabaseQueryGenerator;
import org.apache.hive.ui.internal.query.generators.CreateTableQueryGenerator;
import org.apache.hive.ui.internal.query.generators.DeleteDatabaseQueryGenerator;
import org.apache.hive.ui.internal.query.generators.DeleteTableQueryGenerator;
import org.apache.hive.ui.internal.query.generators.FetchColumnStatsQueryGenerator;
import org.apache.hive.ui.internal.query.generators.RenameTableQueryGenerator;
import org.apache.hive.ui.resources.jobs.JobServiceInternal;
import org.apache.hive.ui.resources.jobs.ResultsPaginationController;
import org.apache.hive.ui.resources.jobs.viewJobs.Job;
import org.apache.hive.ui.resources.jobs.viewJobs.JobController;
import org.apache.hive.ui.resources.jobs.viewJobs.JobImpl;
import org.apache.hive.ui.resources.jobs.viewJobs.JobResourceManager;
import org.apache.hive.ui.resources.settings.Setting;
import org.apache.hive.ui.resources.settings.SettingsResourceManager;
...
public class DDLProxy {
  ...
  public DDLProxy() {
    this.tableMetaParser = new TableMetaParserImpl();
  ...
  private List<TableInfo> getTableInfos(String databaseId) {
    ConnectionConfig hiveConnectionConfig = ConnectionFactory.create();
    DDLDelegator delegator = new DDLDelegatorImpl(ConnectionSystem.getInstance().getActorSystem(), ConnectionSystem.getInstance().getOperationController());
  ...
  public TableMeta getTableProperties( ConnectionConfig connectionConfig, String databaseName, String tableName) {
    DDLDelegator delegator = new DDLDelegatorImpl(ConnectionSystem.getInstance().getActorSystem(), ConnectionSystem.getInstance().getOperationController());
  ...
  public Job alterTable( ConnectionConfig hiveConnectionConfig, String databaseName, String oldTableName, TableMeta newTableMeta, JobResourceManager resourceManager) throws ServiceException {
    String alterQuery = generateAlterTableQuery( hiveConnectionConfig, databaseName, oldTableName, newTableMeta);
  ...
  public String generateAlterTableQuery( ConnectionConfig hiveConnectionConfig, String databaseName, String oldTableName, TableMeta newTableMeta) throws ServiceException {
    TableMeta oldTableMeta = this.getTableProperties(hiveConnectionConfig, databaseName, oldTableName);
  ...
  public Job analyzeTable(String databaseName, String tableName, Boolean shouldAnalyzeColumns, JobResourceManager resourceManager, ConnectionConfig hiveConnectionConfig) throws ServiceException {
    TableMeta tableMeta = this.getTableProperties( hiveConnectionConfig, databaseName, tableName);
  ...
  public ColumnStats fetchColumnStats(String columnName, String jobId) throws ServiceException {
    try {
      ResultsPaginationController.ResultsResponse results = ResultsPaginationController.getResult(jobId, null, null, null, null);
