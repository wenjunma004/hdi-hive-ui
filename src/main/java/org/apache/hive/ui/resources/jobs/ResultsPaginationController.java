...
import org.apache.hive.ui.client.Cursor;
import org.apache.hive.ui.client.EmptyCursor;
...
import org.apache.hive.ui.utils.ResultFetchFormattedException;
import org.apache.hive.ui.utils.ResultNotReadyFormattedException;
...
public class ResultsPaginationController {
  ...
  public static ResultsPaginationController getInstance() {
    if (!viewSingletonObjects.containsKey(HiveUIContext.getInstanceName()))
      viewSingletonObjects.put(HiveUIContext.getInstanceName(), new ResultsPaginationController());
    return viewSingletonObjects.get(HiveUIContext.getInstanceName());
  }
  ...
  public static Response getResultAsResponse(final String jobId, final String fromBeginning, Integer count, String searchId, String format, String requestedColumns) throws HiveClientException {
  ...
  public static ResultsResponse getResult(final String jobId, final String fromBeginning, Integer count, String
    searchId, String requestedColumns) throws HiveClientException {
    final String username = HiveUIContext.getUsername();
