...
package org.apache.hive.ui.resources.jobs.rm;
import org.apache.hive.ui.resources.jobs.util.HttpUtil;
...
public class RMRequestsDelegateImpl implements RMRequestsDelegate {
  ...
  public RMRequestsDelegateImpl( String rmUrl) {
    this.rmUrl = rmUrl;
  }
  ...
  public JSONObject dagProgress(String appId, String dagIdx) {
    ...
    String response;
    try {
      InputStream responseInputStream = HttpUtil.getInputStream(url, "GET");
