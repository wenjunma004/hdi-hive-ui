...
package org.apache.hive.ui.client;
...
import org.apache.hive.ui.actor.message.job.Next;
import org.apache.hive.ui.actor.message.job.NoMoreItems;
import org.apache.hive.ui.actor.message.job.NoResult;
import org.apache.hive.ui.actor.message.job.Result;
...
public class DDLDelegatorImpl implements DDLDelegator {
  ...
  public DDLDelegatorImpl( ActorSystem system, ActorRef controller) {
    this.system = system;
