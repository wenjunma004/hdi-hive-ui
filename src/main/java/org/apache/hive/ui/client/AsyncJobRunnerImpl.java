...
import org.apache.hive.ui.actor.message.CursorReset;
...
import org.apache.hive.ui.actor.message.ResetCursor;
  ...
  public Optional<NonPersistentCursor> getCursor(String jobId, String username) {
    ...
    if(receive instanceof ResultNotReady) {
      ...
      if(iterator.isPresent()) {
        return Optional.of(new NonPersistentCursor(system, iterator.get()));
      } else {
